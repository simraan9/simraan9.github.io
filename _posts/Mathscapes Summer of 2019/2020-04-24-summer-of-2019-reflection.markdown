...
Such a fascinating story, found overlooked in the space of schooling where our mediums to relate or find the relevance of education were limited, and our understanding was overlooked with mere presentation at the time of the test. And grades. If the prior may be prioritized, focusing on teaching me *how I learn* compared with how to learn, instead of every book they handed, things may have been easier. But even still, to explain to somebody what is worthy of their time and attention is an act of curation; benefiting their effort and time. But everyone in the space is different. What binds all humans, if not human virtues of play, creation and learning itself?
...
### **4. Engaging with Complexity, fearlessly**
For me and the children learning AI. We’re humans and we look for patterns!

![A pictures of stars](/images/stars.png)
<div align="center"> Source: Wikimedia Commons </div>
<div align="center">(https://commons.wikimedia.org/wiki/File:Stars_in_the_Andromeda_Galaxy%27s_disc.jpg)  </div>
...
*Step 1.* [How might we teach AI to school-children?](https://medium.com/mathscapes/building-sigmoid-open-toolkit-for-teaching-ai-in-k-12-fcc0274e7d61)

*Step 0.* How might I understand AI?
...
![A pictures of stars](/images/K12C.png)
<div align="center"> Work in Progress : Sigmoid </div>
...
It felt like nothing made sense while everything did.
...
#### **Make something of that information.**
  - a diligent reminder
...
If you measure consciously, you may be able to stick with your *plan of action.* But ***Actionable*** is also a verb, anything **more than** just a thought in your head. Logically dictating me back to making/creating with what I know. (I hated the word make for how it would always come a full circle) I observed how my plans were written. How much the language and the words I used, the detail in the tasks I’d pile, and the time I seemed to give but consistently felt like I couldn’t do enough. Words became critical. Explanations, necessary. And observations — documented, a must. My blog saw more writing than I ever did in the past 3 years.
...
#### **7. Patterns to Play with Time — The Relevance of Algorithms**
...
> I have gone from **‘being fascinated with the parallels in machines and the human mind’** to recognizing that **both are just performing math**, by running on algorithms.
