...
Policymakers also make algorithms, only super general with means of diluting problems instead of eradicating it, considering eradicating is expected from algorithms.
gauging how much impact they are really making. Funny how the non-questioner is blamed than considered.
